...
including the Frontier v4 bundle and report page checks.
Run the matching `python3 scripts/verify_swe_v4_v3N_pdf.py` (needs pypdf) after regenerating a PDF.
Run `python3 scripts/build_swe_v4_board.py --check` after touching any Frontier v4 bundle; the leaderboard block is generated from them.
