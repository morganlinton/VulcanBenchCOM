...
```sh
python3 -m unittest scripts/test_swe_v4_v35.py
...
the published rates, rebuilds the nine aggregates and their standard errors
...
- [Protocol document with amendments v3.1 to v3.5](https://github.com/morganlinton/VulcanBench/blob/main/docs/judging/code-quality-maintenance-v3.md)
...
- [v3.5 runner](https://github.com/morganlinton/VulcanBench/blob/main/harness/maintenance_review_v35.py), which reuses the frozen [v3 implementation](https://github.com/morganlinton/VulcanBench/blob/main/harness/maintenance_review_v3.py), and the [operator wrapper](https://github.com/morganlinton/VulcanBench/blob/main/harness/maintenance_review_v3_resume.py)
- [Population record and card generators](https://github.com/morganlinton/VulcanBench/tree/main/docs/results/swe-v4-gpt55-luna-2026-09)
...
from. The export script, `scripts/export_swe_v4_v35_evidence.py`, recomputes
...
```sh
python3 -m harness.maintenance_review_v35 prepare
VB_MAINT_MODULE=harness.maintenance_review_v35 python3 -m harness.maintenance_review_v3_resume calibrate --panel muse
VB_MAINT_MODULE=harness.maintenance_review_v35 python3 -m harness.maintenance_review_v3_resume calibrate --panel grok
VB_MAINT_MODULE=harness.maintenance_review_v35 python3 -m harness.maintenance_review_v3_resume run --panel muse
VB_MAINT_MODULE=harness.maintenance_review_v35 python3 -m harness.maintenance_review_v3_resume probe --panel muse
VB_MAINT_MODULE=harness.maintenance_review_v35 python3 -m harness.maintenance_review_v3_resume run --panel grok
VB_MAINT_MODULE=harness.maintenance_review_v35 python3 -m harness.maintenance_review_v3_resume probe --panel grok
python3 -m harness.maintenance_review_v35 summarize
```
